...
export class AddEvent extends Component {
    ...
    render() {
        ...
        if (this.flag) {
            return (
                <div className="reg" data-testid="submit">
                    <h2>Invalid credentials</h2>
                    <form method="post" onSubmit={this.onSubmit}>
                        <p><input type="text" name="name" placeholder="Name" onChange={e => this.name = e.target.value}/>
                        </p>
                        <p><input type="text" name="content" placeholder="Content" onChange={e => this.content = e.target.value}/></p>
                        <p><input type="text" name="date" placeholder="Date" onChange={e => this.date = e.target.value}/>
                        </p>
